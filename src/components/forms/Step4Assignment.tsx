      ...
      try {
        const response = await fetch('/api/assignment', {
          ...
          body: JSON.stringify({
            ...
            selfConfidence: formData.selfConfidence,
            hasPartner: formData.hasPartner,
            partnerName: formData.partnerName,
            dietaryRequirements: formData.dietaryRequirements,
            jkvJoinYear: formData.jkvJoinYear,
            jkvExitYear: formData.jkvExitYear,
            borrelCount2025: formData.borrelCount2025,
            borrelPlanning2026: formData.borrelPlanning2026,
